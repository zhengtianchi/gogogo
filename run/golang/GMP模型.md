...
一切的程序只能串行发生。
![5-单进程操作系统.png](img/1460000021951123.png)
...
![6-多进程操作系统.png](img/1460000021951124.png)
...
![7-cpu切换浪费成本.png](img/1460000021951126.png)
...
![8-线程的内核和用户态.png](img/1460000021951125.png)

这样，我们再去细化去分类一下，`内核线程依然叫“线程(thread)”，用户线程叫“协程(co-routine)".`

![9-协程和线程.png](img/1460000021951128.png)
...
![10-N-1关系.png](img/1460000021951127.png)
...
![11-1-1.png](img/1460000021951129.png)

> #### M:N关系

M个协程绑定1个线程，是N:1和1:1类型的结合，克服了以上2种模型的缺点，但实现起来最为复杂。

![12-m-n.png](img/1460000021951130.png)
...
![13-gm.png](img/1460000021951134.png)

下面我们来看看被废弃的golang调度器是如何实现的？

![14-old调度器.png](img/1460000021951135.png)
...
![15-gmp.png](img/1460000021951136.png)
...
![16-GMP-调度.png](img/1460000021951137.jpeg)
...
> **复用线程**：避免频繁的创建、销毁线程，而是对线程的复用。`(自旋线程)`
...
![18-go-func调度周期.jpeg](img/1460000021951139.jpeg)
...
![17-pic-go调度器生命周期.png](img/1460000021951138.png)
...
![19-go-trace1.png](img/1460000021951140.png)

![20-go-trace2.png](img/1460000021951141.png)

**G信息**

点击Goroutines那一行可视化的数据条，我们会看到一些详细的信息。

![20-go-trace3.png](img/1460000021951142.png)
...
![22-go-trace4.png](img/1460000021951143.png)

一共有两个M在程序中，一个是特殊的M0，用于初始化使用，这个我们不必讨论。

**P信息**
![23-go-trace5.png](img/1460000021951144.png)
...
![24-go-trace6.png](img/1460000021951145.png)

我们会发现，确实G18在P0上被运行的时候，确实在Threads行多了一个M的数据，点击查看如下：

![25-go-trace7.png](img/1460000021951146.png)
...
![26-gmp场景1.png](img/1460000021951147.png)
...
![27-gmp场景2.png](img/1460000021951149.png)
...
![28-gmp场景3.png](img/1460000021951150.png)
...
![29-gmp场景4.png](img/1460000021951151.png)
...
![30-gmp场景5.png](img/1460000021951152.png)
...
![31-gmp场景6.png](img/1460000021951154.png)
...
![32-gmp场景7.001.jpeg](img/1460000021951153.jpeg)
...
![33-gmp场景8.png](img/1460000021951156.png)
...
![34-gmp场景9.png](img/1460000021951155.png)
...
![35-gmp场景10.png](img/1460000021951157.png)

##### (11)场景11

G8创建了G9，假如G8进行了**非阻塞系统调用**。
![36-gmp场景11.png](img/1460000021951158.png)

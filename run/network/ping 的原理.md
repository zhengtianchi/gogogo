...
- 在规定的时候间内，源主机如果没有接到 ICMP 的应答包，则说明目标主机不可达（类型3）；
...
![img](https://archerzdip.github.io/assets/post/7d566a33a98a46fa7acbcd64b8ce6492943508b619f356f9b79b516afd9f1ce7.png)
...
所以，**当差错报文类型是`端口不可达`时，说明发送方发出的 UDP 包到达了目的主机。**
